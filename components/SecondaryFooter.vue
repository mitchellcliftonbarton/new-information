<template>
  ...
  >
    <div class="left flex justify-start items-center lg:mr-16">
      <p class="h-text text-black inline-block">Newsletter</p>
    </div>
    ...
    <div class="w-1/2 md:w-full">
      ...
      <div id="mc_embed_signup" class="inline">
        <form
          ref="form"
          action="https://studio.us5.list-manage.com/subscribe/post?u=449e3187f98c4ba89d808f08d&amp;id=7463220291"
          method="post"
        ...
        >
          <div id="mc_embed_signup_scroll" class="relative flex w-full">
            <div class="mc-field-group input">
              <label class="wcag-hidden" for="mce-EMAIL"
            ...
            <div style="position: absolute; left: -5000px;" aria-hidden="true">
              <input
                type="text"
                name="b_449e3187f98c4ba89d808f08d_7463220291"
                tabindex="-1"
                value=""
              />
            </div>

  ...
  >
    <div class="left lg:mr-16">
      <div class="flex flex-col items-start h-text">
        <nuxt-link :to="backLink" class="h-text text-black inline-block"
        ...
        <nuxt-link to="/log" class="h-text text-black inline-block"
          >Studio Log</nuxt-link
        >
      </div>
    </div>

    <div
      class="w-1/2 lg:w-1/3 lg:mr-16 lg:max-w-3xl pl-3 md:pl-0 pr-16 md:pr-0"
    >
      <div
